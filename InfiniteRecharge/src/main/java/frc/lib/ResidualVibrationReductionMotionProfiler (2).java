 ...
 * .pdf
 */
public class ResidualVibrationReductionMotionProfiler implements IMotionProfile {
    ...
    public double getPosition() {
        return getPosition(getTimeProfiler().getDeltaTime(false));
    }

    @Override
    public double getVelocity() {
        return getVelocity(getTimeProfiler().getDeltaTime(false));
    }

    @Override
    public double getAcceleration() {
        return getAcceleration(getTimeProfiler().getDeltaTime(false));
    }

    @Override
    public double getJerk() {
        return getJerk(getTimeProfiler().getDeltaTime(false));
    }
    ...
    public double getRuntime() {
        return getTimeProfiler().getDeltaTime(false);
    }
    ...
    public boolean isDone() {
        return isDone(getTimeProfiler().getDeltaTime(false));
    }
